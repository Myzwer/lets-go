        ...
        <div class="grid grid-cols-12 lg:max-w-7xl gap-4 relative z-10 mx-6 xl:mx-auto">
            ...
            <div class="col-span-12 mt-5">
                <div class="grid grid-cols-12">
                    ...
                    <div class="col-span-8 mt-5">
                        <p class="pt-2 text-lg text-white font-bold text-left"><?php the_field('address', $event_id); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 mt-5">
                <div class="pb-5">
                    ...
                    <p class="pt-2 text-lg text-white font-bold"><?php the_field('children_restrictions', $event_id); ?></p>
                </div>
            </div>
            ...
            <div class="col-span-12 mt-5">
                <div class="pb-5">
                    ...
                    <p class="pt-2 text-lg text-white font-bold"><?php the_field('weather', $event_id); ?></p>
                </div>
            </div>
